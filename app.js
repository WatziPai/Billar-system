...
function actualizarConsumoDueno() {
    ...
    // INSERCIÓN DIRECTA Y SIMPLE
    container.innerHTML = '<div style="text-align: center; padding: 50px; background: yellow;"><p style="font-size: 48px; margin: 0;">🍽️</p><p style="margin-top: 10px; color: black;">No hay consumos registrados desde el último cierre</p><button class="btn btn-primary" onclick="showModalConsumoDueno()" style="margin-top: 20px; padding: 12px 30px;">➕ Registrar Primer Consumo</button></div>';
    
    console.log('✅ HTML insertado. Longitud:', container.innerHTML.length);
}
